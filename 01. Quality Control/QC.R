...
#============================================================Run sc_qc.R==================================================================
seurat_obj_1_qc <- sc_qc(seurat_obj = seurat_obj_1, out_dir = "./01.QC/")
seurat_obj_2_qc <- sc_qc(seurat_obj = seurat_obj_2, out_dir = "./01.QC/")
...
seurat_obj_1_db <- sc_doublefinder(seurat_obj= seurat_obj_1_filtered ,
                                   max.dim = 40 , 
                                   max.pcs=40, 
                                   pN = 0.25, 
                                   out_dir = "./01.QC/")
