...
### 01.Run sc_run.q
Perform separate QC for each individual sample, including the removal of Mit-related genes, RBC-related genes, and ribo-related genes. Name the sample (e.g., <mark>*Seurat_obj_1*</mark>) and name the output file *seurat_obj_1_qc*.<br>
...
Remove doublets from individual samples (inferior - quality doublets are eliminated using Doublefinder), and name the output file *seurat_obj_1_db*.

### 03.Run sc_decontx.R
使用*Decontx*去除环境RNA污染（可选）<br>
